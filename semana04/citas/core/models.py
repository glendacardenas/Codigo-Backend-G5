...
class PersonaModel(models.Model):
    ...
    personaNombre = models.CharField(
        ...
        unique=False,
        null=False,
        # si no le indicamos entonces su nombre sera el mismo que el atributo (personaNombre)
        db_column='nombre'
    )
    ...
    personaEstadoCivil = models.CharField(
        ...
        # si no se proporciona un valor inicial, entonces este sera el valor por defecto
    ...
    personaFoto = models.ImageField(
        db_column='foto',
        # es la carpeta donde se almacenera estos archivos dentro del proyecto
        upload_to='personas/',
        null=True,
    )
