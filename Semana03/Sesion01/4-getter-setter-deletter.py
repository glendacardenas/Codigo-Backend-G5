...
# deletter > sirve para eliminar un atributo privado
    ...
    # property > es una propiedad de las clases que sirve para indicar el comportamiento que va a tener el atributo publico en relacional atributo
    # privado que hemos definido con su getter , setter y deletter siendo el deleter opcional
...
del microondas.nombre_electrodomesticos
