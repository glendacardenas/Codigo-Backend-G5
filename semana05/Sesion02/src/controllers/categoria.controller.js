...
export const listarCategoria = async (req, res) => {
    ...
    //retorna un array de todas las categorias encontradas en la base de datos y opcionalmente le 
    //podremos pasar una condicional (where)
...
export const actualizarCategoria = async (req, res) => {
    ...
    try {
        ...
        console.log(error);
        // se dispara el catch cuando no se encuentre la categoria o cuando la informacion 
        //a actualizar sea incorrecta (cuando el tipo de dato no corresponda)
